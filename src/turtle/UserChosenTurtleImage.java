...
public class UserChosenTurtleImage extends TurtleImage {
    ...
    public UserChosenTurtleImage (Image image) {
        ...
        setTranslateX(-1 * (ourSize.getWidth() / 2 + myBorderWidth));
        setTranslateY(-1 * (ourSize.getHeight() / 2 + myBorderWidth));
    }
    ...
    private void createBorder () {
        myBorder =
                new Rectangle(ourSize.getHeight() + 2 * myBorderWidth, ourSize.getWidth() + 2 *
                              myBorderWidth);
