...
public class SLogoMenuBar extends MenuBar {
    ...
    private void initializeFileMenu () {
        ...
        myNewWorkspaceMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(NEW_WORKSPACE_KEY),
                               event -> myParentView.addNewWorkspace());
        mySaveWorkspaceMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(SAVE_WORKSPACE_KEY),
                               event -> myParentView.saveWorkspace());
        myLoadWorkspaceMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(LOAD_WORKSPACE_KEY),
                               event -> myParentView.loadWorkspace());
        myLoadFileMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(LOAD_FILE_KEY),
    ...
    private void initializeGridMenu () {
        ...
        myAddTurtleMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(ADD_TURTLE_KEY),
                               event -> myParentView.addTurtleClicked());
        myGridLinesMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(GRID_LINES_KEY),
                               event -> myParentView.toggleGridLines());
        myTurtleImageMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(TURTLE_IMAGE_KEY),
                               event -> myParentView.changeTurtleImages());
        myPenSettingsMenuItem =
                createMenuItem(GUIReferenceLibrary.getStringTranslation(PEN_SETTINGS_KEY),
