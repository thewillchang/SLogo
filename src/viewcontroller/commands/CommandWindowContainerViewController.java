...
MainModelObserver {
    ...
    private void placeCommandWindows () {
        ...
        myCommandWindowVerticalBox.getChildren().addAll(
                                                        userDefinedHorizontalBox,
                                                        myCommandHistoryView.getNode(),
                                                        myCommandPromptView.getNode(),
                                                        myCommandStatusView.getNode());
    ...
    private HBox placeUserDefinedBoxes () {
        ...
        myUserDefinedMethodsView =
                new UserDefinedMethodsViewController(
                                                     SIZE.width / 2, SIZE.height / 4, this);
        myUserDefinedVariablesView =
                new UserDefinedVariablesViewController(
                                                       SIZE.width / 2, SIZE.height / 4, this);
