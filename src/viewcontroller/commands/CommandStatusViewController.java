...
public class CommandStatusViewController extends CommandWindowViewController
	...
	/**
	 * Display the return messages from the model If the parsing did not
	 * function properly (i.e. invalid inputs), then the error message will be
	 * displayed.
	 */
	@Override
	...
	public void applyTranslations() {
		myStatusTranslation = GUIReferenceLibrary
				.getStringTranslation(STATUS_KEY);
	}
