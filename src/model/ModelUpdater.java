...
public class ModelUpdater {
    ...
    public Map<Turtle, List<TransitionState>> updateModel (Collection<Turtle> turtles,
    ...
    private Map<Turtle, List<TransitionState>> createTurtleTransitionMapping (Collection<Turtle> turtles,
                                                                              List<TransitionState> states) {
