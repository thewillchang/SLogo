...
public class MainModel {
    ...
    public MainModel (String language) {
        ...
        myCommandHistoryModel = new CommandHistoryModel();
        myUserDefinedMethodsModel = new UserDefinedCommandsModel();
        myUserDefinedVariablesModel = new UserDefinedVariablesModel();
    ...
    public MainModel (String language, CommandHistoryModel cHM,
        ...
        myObservers = new ArrayList<>();
        myTurtles = new ArrayList<>();
        myCommandHistoryModel = cHM;
        myUserDefinedMethodsModel = uDCM;
        myUserDefinedVariablesModel = uDVM;
        myInterpreter = new Interpreter(this);
        myTurtleAdded = false;
        myAnimation = new ParallelTransition();
        myTurtleListHistory = new TurtleListHistory();
        myBackgroundColor = Color.valueOf(backGroundColor);
    }
    ...
    public Turtle getActiveTurtle () {
        for (Turtle turtle : myTurtles) {
            if (turtle.isSelected()) { return turtle; }
        }
        return null;
    }
